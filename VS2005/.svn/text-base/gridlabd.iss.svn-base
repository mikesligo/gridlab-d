...
OutputBaseFilename=gridlabd-2.2
AppName=GridLAB-D
AppVerName=GridLAB-D 2.2
; --RELEASE--
...
Name: creategltemp; Description: "Create GLTEMP (recommended)"; GroupDescription: Environment; 
...
Root: HKCU; SubKey: Environment; ValueType: string; ValueName: GLTEMP; ValueData: {userappdata}\temp\gridlabd; Flags: uninsdeletevalue deletevalue; Check: "not (IsAdminLoggedOn() or IsPowerUserLoggedOn())"; Tasks: creategltemp; 
Root: HKLM; SubKey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: string; ValueName: GLTEMP; ValueData: {userappdata}\temp\gridlabd; Flags: uninsdeletevalue deletevalue; Check: "IsAdminLoggedOn() or IsPowerUserLoggedOn()"; Tasks: creategltemp; 
